...
from users.views import LoginView, LogoutView, MeView, MeUpdateView, RegisterView, MyTransactionsView, MyCoinTransactionsView, MyHoldingsView, MyCoinHoldingsView, ConfirmEmailView
